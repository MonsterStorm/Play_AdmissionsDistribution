...
public class Advertisment extends Model {
	...
	// -- 查询
	public static Model.Finder<Long, Advertisment> finder = new Model.Finder(Long.class, Advertisment.class);
	 ...
	 * @return
	 */
	public static Page<Advertisment> findPage(DynamicForm form, int page,
			Integer pageSize) {
	 ...
	 * @return
	 */
	public static Advertisment addOrUpdate(Advertisment advertisment, FilePart fileLogo){
		if (advertisment != null) {
			...
			if (advertisment.id == null) {// 新增
				...
				advertisment.advertismentStatistics = new AdvertismentStatistics(advertisment);//访问统计
				advertisment.save();
			} else {// 更新
				advertisment.lastModified = System.currentTimeMillis();
				advertisment.update();
